...
export const phases = [
  ...
  },
  {
    ...
    color: "orange",
    dates: "Mon Jun 15",
    routeUrl: "https://www.google.com/maps/dir/Zé+da+Mouraria,+Lisboa/Praça+do+Comércio,+Lisboa/Arco+da+Rua+Augusta,+Lisboa/Chiado,+Lisboa/Miradouro+de+Santa+Catarina,+Lisboa",
    days: [
      {
        date: "Mon Jun 15",
        location: "Lisbon",
        slots: [
          { type: "logistics",  label: "~11:00 — Drive to Lisbon (~40 min)", confirmed: true,  note: "Park near Baixa / Martim Moniz" },
          { type: "restaurant", label: "12:00 — Lunch at Zé da Mouraria", confirmed: true,  note: "Ramiro's shut Mondays — Zé da Mouraria is the move: acclaimed Mouraria tasca, lunch only (12–4), cash, no bookings. Go right at opening for a table for 6" },
          { type: "activity",   label: "Terreiro do Paço + Baixa",      confirmed: true,  note: "Praça do Comércio, Rua Augusta arch (climb it for the view), Santa Justa lift" },
          { type: "activity",   label: "Chiado + sunset miradouro",     confirmed: true,  note: "Rua Garrett, A Brasileira, Carmo ruins → sunset drinks at Miradouro de Santa Catarina" },
          { type: "restaurant", label: "Early light dinner before heading back", confirmed: false, note: "Keep it light after the big lunch — petiscos & a drink in Bairro Alto, or Cortesia for a sit-down" },
          { type: "logistics",  label: "~9:30 — Back to Praia Grande",  confirmed: true },
        ],
      },
    ],
  },
